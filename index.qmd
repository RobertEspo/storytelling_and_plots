...
![](assets/usa_bad_plot.jpg)

##

![](assets/usa_ok_plot.jpg)
...
Make sure to include the unit of measure!
...
- Easier to use with categorical data
- Color-blind friendly
- Should be used meaningfully
...
penguins %>%
  na.omit() %>%
  ggplot(aes(x = species, y = flipper_length_mm, fill = body_mass_g)) +
  geom_boxplot() +
  geom_point(shape = 21, size = 3, alpha = 0.7, position = position_jitter(width = 0.2)) +
  scale_fill_viridis_c(option = "mako") +
  labs(
    title = "Flipper Length and Body Mass of Penguins",
    x = "Species",
    y = "Flipper Length (mm)",
    fill = "Body Mass (g)"
  )
